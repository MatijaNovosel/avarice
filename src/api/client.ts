...
export class Client {
    ...
    account_Create(payload: CreateAccountModel , cancelToken?: CancelToken | undefined): Promise<FileResponse | null> {
        let url_ = this.baseUrl + "/api/account";
        url_ = url_.replace(/[?&]$/, "");
    ...
    account_GetExpenseAndIncomeInTimePeriod(id: number , cancelToken?: CancelToken | undefined): Promise<AccountExpenseAndIncomeModel> {
    ...
    protected processAccount_GetExpenseAndIncomeInTimePeriod(response: AxiosResponse): Promise<AccountExpenseAndIncomeModel> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
    ...
    account_GetAccountHistory(id: number, timePeriod: TimePeriodEnum | undefined , cancelToken?: CancelToken | undefined): Promise<AccountHistoryModel[]> {
    ...
    protected processAccount_GetAccountHistory(response: AxiosResponse): Promise<AccountHistoryModel[]> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(AccountHistoryModel.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
    ...
    auth_Register(payload: RegistrationModel , cancelToken?: CancelToken | undefined): Promise<RegisterResult> {
    ...
    category_Create(newCategory: CreateCategoryModel , cancelToken?: CancelToken | undefined): Promise<void> {
        let url_ = this.baseUrl + "/api/category";
        url_ = url_.replace(/[?&]$/, "");
    ...
    template_Get(skip: number | undefined, take: number | undefined , cancelToken?: CancelToken | undefined): Promise<PageableCollectionOfTemplateModel> {
        let url_ = this.baseUrl + "/api/template?";
        if (skip === null)
    ...
    protected processTemplate_Get(response: AxiosResponse): Promise<PageableCollectionOfTemplateModel> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
    ...
    transaction_Get(skip: number | undefined, take: number | undefined, description: string | null | undefined, transactionType: string | null | undefined, categoryType: number | null | undefined , cancelToken?: CancelToken | undefined): Promise<PageableCollectionOfTransactionModel> {
        let url_ = this.baseUrl + "/api/transaction?";
        if (skip === null)
            throw new Error("The parameter 'skip' cannot be null.");
        else if (skip !== undefined)
    ...
    transaction_GetHeatmap(  cancelToken?: CancelToken | undefined): Promise<TransactionActivityHeatmapModel[]> {
    ...
    protected processTransaction_GetHeatmap(response: AxiosResponse): Promise<TransactionActivityHeatmapModel[]> {
        const status = response.status;
        let _headers: any = {};
        if (response.headers && typeof response.headers === "object") {
            for (let k in response.headers) {
        ...
        if (_data) {
            if (Array.isArray(_data["results"])) {
                ...
                for (let item of _data["results"])
                    this.results!.push(TemplateModel.fromJS(item));
            }
...
export class TemplateModel extends BaseModel implements ITemplateModel {
    ...
    override init(_data?: any) {
        ...
        if (_data) {
            ...
            this.description = _data["description"];
            this.currency = _data["currency"];
            this.category = _data["category"] ? TemplateCategoryModel.fromJS(_data["category"]) : <any>undefined;
